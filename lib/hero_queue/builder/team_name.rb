module Builder
	class TeamName
		...
		private
			...
			def book_genre
				genres = ['Classic', 'Fable', 'Fairy tale', 'Fantasy', 'Folklore', 'Horror', 'Legend', 'Mystery', 'Mythology', 'Suspense', 'Thriller', 'Western']
			end

			def creature
				creatures = ['ants', 'bats', 'bears', 'bees', 'birds', 'buffalo', 'cats', 'dogs', 'dolphins', 'ducks', 'elephants', 'fishes', 'foxes', 'frogs', 'geese', 'horses', 'kangaroos', 'lions', 'monkeys', 'owls', 'penguins', 'rabbits', 'tigers', 'wolves', 'zebras', 'banshees', 'crows', 'black cats', 'chimeras', 'ghosts', 'dragons', 'dwarves', 'elves', 'giants', 'gnomes', 'goblins', 'gooses', 'griffins', 'oracles', 'sorcerors', 'spiders', 'spirits', 'vampires', 'warlocks', 'werewolves', 'witches', 'zombies', 'druids']
			end
